...
public class RuntimeReflectionRegistrationFeature implements Feature {
	...
	public void beforeAnalysis(BeforeAnalysisAccess access) {
	    ...
	    try {
	        ...
	        RuntimeReflection.register(WebSocketSessionBuilder.class);
	        RuntimeReflection.register(WebSocketSessionBuilder.class.getDeclaredConstructor());
	        RuntimeReflection.register(WebSocketSessionBuilder.class.getMethods());
